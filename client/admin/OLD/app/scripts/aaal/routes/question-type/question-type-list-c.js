...
(function() {
    ...
    angular
        .module('aaal')
        .controller('QuestionTypeListCtrl', QuestionTypeListCtrl);

    /* @ngInject */
    function QuestionTypeListCtrl(QuestionType) {
        var vm = this;
        ...
        vm.viewState = 'private.QuestionTypeView';
        vm.editState = 'private.QuestionTypeEdit';
