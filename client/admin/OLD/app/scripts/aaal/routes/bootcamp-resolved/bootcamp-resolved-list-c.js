...
(function() {
    ...
    angular
        .module('aaal')
        .controller('BootcampResolvedListCtrl', BootcampResolvedListCtrl);

    /* @ngInject */
    function BootcampResolvedListCtrl(BootcampResolved) {
        var vm = this;
        ...
        vm.viewState = 'private.BootcampResolvedView';
        vm.editState = 'private.BootcampResolvedEdit';
