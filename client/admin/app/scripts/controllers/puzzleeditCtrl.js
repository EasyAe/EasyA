 ...
 */
app
    .controller('puzzleeditCtrl', function($scope, questionServices, examServices, Upload, $uibModal, $state, $stateParams, $window, $timeout) {
        $scope.page = {
            title: 'Users',
            ...
            if($scope.content =="other"){
                ...
                angular.forEach($scope.pictureAnsChoosed, function(ans, anskey) {
                    if (angular.isObject(ans)) {
                        ...
                        var ansData = {
                            correct: corr,
                            // order: $scope.question.answers[anskey].order,
                            id:anskey,
                            questionId: id
                        }
